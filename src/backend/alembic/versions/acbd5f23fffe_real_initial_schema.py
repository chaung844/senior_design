...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'manager', 'viewer', name='user_role_enum', native_enum=False), nullable=False),
    ...
    sa.Column('match_status', sa.Enum('unmatched', 'matched', 'manual', name='receipt_match_status_enum', native_enum=False), nullable=False),
    sa.Column('uploaded_by', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['uploaded_by'], ['users.user_id'], ondelete='SET NULL'),
    ...
    sa.Column('currency', sa.String(length=3), server_default='USD', nullable=False),
    sa.Column('match_status', sa.Enum('unmatched', 'matched', 'manual', name='statement_line_match_status_enum', native_enum=False), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['statement_id'], ['bank_statements.statement_id'], ondelete='CASCADE'),
